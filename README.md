...
2) Paste your OMDb API key in **Setup** and click **Save Key**.
3) Pick preferences and click **Get Recommendations**.
4) Use **Add Movies** to expand your personal pool; your movies show up in the carousel.
